/*! For license information please see eba393d24092e219df13.js.LICENSE.txt */
'use strict';
(self.webpackChunkmy_app = self.webpackChunkmy_app || []).push([
  [7276],
  {
    37276: (e, t, o) => {
      ...
      function r(e, t = null, o = {}) {
        const n = document.createElement(e);
        Array.isArray(t)
          ? n.classList.add(...t)
          : null !== t && n.classList.add(t);
        for (const r in o) o.hasOwnProperty(r) && (n[r] = o[r]);
        return n;
      }
      var i = ((e) => (
        (e.Empty = 'empty'),
      ...
      class a {
        constructor({ api: e, config: t, onSelectFile: o, readOnly: n }) {
          (this.api = e),
            ...
            (this.nodes = {
              ...
              imageContainer: r('div', [this.CSS.imageContainer]),
              fileButton: this.createFileButton(),
              imageEl: void 0,
              imagePreloader: r('div', this.CSS.imagePreloader),
              caption: r('div', [this.CSS.input, this.CSS.caption], {
                contentEditable: !this.readOnly,
              }),
              url: r('div', [this.CSS.input, this.CSS.url], {
                contentEditable: !this.readOnly,
              }),
            }),
            (this.nodes.caption.dataset.placeholder =
              this.config.captionPlaceholder),
            (this.nodes.url.dataset.placeholder = this.config.urlPlaceholder),
        ...
        render(e) {
          return (
            void 0 === e.file || 0 === Object.keys(e.file).length
        ...
        fillImage(e) {
          ...
          'VIDEO' === t &&
            ...
            (o.playsinline = !0),
            (n = 'loadeddata')),
            (this.nodes.imageEl = r(t, this.CSS.imageEl, o)),
            this.nodes.imageEl.addEventListener(n, () => {
              this.toggleStatus('filled'),
                void 0 !== this.nodes.imagePreloader &&
                  (this.nodes.imagePreloader.style.backgroundImage = '');
            }),
            this.nodes.imageContainer.appendChild(this.nodes.imageEl);
        }
        fillCaption(e) {
          void 0 !== this.nodes.caption && (this.nodes.caption.innerHTML = e);
        }
        fillUrl(e) {
          void 0 !== this.nodes.url && (this.nodes.url.innerHTML = e);
        }
        get CSS() {
          return {
        ...
        createFileButton() {
          const e = r('div', [this.CSS.button]);
          return (
            (e.innerHTML =
              this.config.buttonContent ??
              `${n} ${this.api.i18n.t('Select an Image')}`),
      ...
      window,
        (l.exports = (function (e) {
          ...
          function (e, t, o) {
            (function (e) {
              ...
              (a.prototype.catch = function (e) {
                ...
                (a.race = function (e) {
                  return new a(function (t, o) {
                    for (var n = 0, r = e.length; n < r; n++) e[n].then(t, o);
                  });
                }),
                (a._immediateFn =
                  ('function' == typeof e &&
              ...
              p =
                ((i = function (e) {
                  return new Promise(function (t, o) {
                    (e = s(e)), (e = l(e)).beforeSend && e.beforeSend();
                    ...
                    n.open(e.method, e.url),
                      ...
                      Object.keys(e.headers).forEach(function (t) {
                        var o = e.headers[t];
                        n.setRequestHeader(t, o);
                      });
                    var r = e.ratio;
                    n.upload.addEventListener(
                      'progress',
                      function (t) {
                        var o = Math.round((t.loaded / t.total) * 100),
                          n = Math.ceil((o * r) / 100);
                        e.progress(Math.min(n, 100));
                      },
                      !1
                    ),
                      n.addEventListener(
                      ...
                      (n.onreadystatechange = function () {
                        if (4 === n.readyState) {
                          ...
                          var r = d.parseHeaders(n.getAllResponseHeaders()),
                            i = { body: e, code: n.status, headers: r };
                          u(n.status) ? t(i) : o(i);
                        }
                      }),
                      n.send(e.data);
                  ...
                  if (
                    ...
                    e.type &&
                      ('string' != typeof e.type ||
                        !Object.values(r).includes(e.type)))
                  )
                    throw new Error(
                      "`type` must be taken from module's \xabcontentType\xbb library"
                    );
                ...
                (l = function (e) {
                  switch (e.method) {
                    ...
                    case 'UPDATE':
                      ...
                      (d.isFormData(e.data) || d.isFormElement(e.data)) &&
                        (o = r.FORM),
                        (e.data = c(e.data, o)),
                        o !== p.contentType.FORM &&
                ...
                }),
                {
                  ...
                  transport: function (e) {
                    return (
                      ...
                      d.selectFiles(e).then(function (t) {
                        for (var o = new FormData(), n = 0; n < t.length; n++)
                          o.append(e.fieldName, t[n], t[n].name);
                        d.isObject(e.data) &&
                  ...
                  selectFiles: function (e) {
                    return delete (e = s(e)).beforeSend, d.selectFiles(e);
                  },
                });
            e.exports = p;
          },
          ...
          function (e, t, o) {
            (function (e) {
              var n =
                  (void 0 !== e && e) || (typeof self < 'u' && self) || window,
              ...
              (t.setTimeout = function () {
                ...
                (t.setInterval = function () {
                  return new i(
                    r.call(setInterval, n, arguments),
                    clearInterval
                  );
                }),
          ...
          function (e, t, o) {
            (function (e, t) {
                ...
                if (!e.setImmediate) {
                  ...
                  (p = p && p.setTimeout ? p : e),
                    ...
                    (p.setImmediate = function (e) {
                      ...
                      for (
                        var t = new Array(arguments.length - 1), o = 0;
                        o < t.length;
                        o++
                      )
                        t[o] = arguments[o + 1];
              ...
              })(typeof self > 'u' ? (void 0 === e ? this : e) : self);
            }).call(this, o(0), o(7));
          },
          function (e, t) {
            var o,
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return new Promise(function (t, o) {
                        ...
                        (n.type = 'file'),
                          e.multiple && n.setAttribute('multiple', 'multiple'),
                          e.accept && n.setAttribute('accept', e.accept),
                          ...
                          n.addEventListener(
                            ...
                            function (e) {
                              ...
                              t(o), document.body.removeChild(n);
                            },
                            !1
                          ),
                          n.click();
      ...
      class d {
        ...
        uploadByFile(e, { onPreview: t }) {
          ...
          if (
            ...
            t.append(this.config.field ?? 'image', e),
              this.config.additionalRequestData &&
      ...
      class p {
        constructor({ data: e, config: t, api: o, readOnly: n, block: r }) {
          (this.api = o),
            (this.readOnly = n),
            (this.block = r),
            (this.config = {
              ...
              captionPlaceholder: this.api.i18n.t(
                t.captionPlaceholder ?? 'Caption'
              ),
              urlPlaceholder: this.api.i18n.t(t.urlPlaceholder ?? 'Link'),
              buttonContent: t.buttonContent,
              uploader: t.uploader,
              actions: t.actions,
              onSelectFile: t.onSelectFile,
            }),
            (this.uploader = new d({
              config: this.config,
            ...
            (this.ui = new a({
              ...
              onSelectFile: () => {
                var e, t;
                return null == (t = (e = this.config).onSelectFile)
                  ? void 0
                  : t.call(
                      e,
                      this.onUpload.bind(this),
                      this.uploadingFailed.bind(this)
                    );
              },
              readOnly: n,
            })),
        ...
        save() {
          const e = this.ui.nodes.caption,
            t = this.ui.nodes.url;
          return (
            (this._data.caption = e.innerHTML),
            (this._data.url = t.innerHTML),
            this.data
          );
        }
        renderSettings() {
          return p.tunes.concat(this.config.actions || []).map((e) => ({
            icon: e.icon,
        ...
        async onPaste(e) {
          switch (e.type) {
            case 'tag': {
              ...
              if (/^blob:/.test(t.src)) {
                const e = await (await fetch(t.src)).blob();
                this.uploadFile(e);
                break;
              }
        ...
        set data(e) {
          (this.image = e.file),
            ...
            this.ui.fillUrl(this._data.url),
            p.tunes.forEach(({ name: t }) => {
              const o = typeof e[t] < 'u' && (!0 === e[t] || 'true' === e[t]);
              this.setTune(t, o);
            });
        }
        get data() {
